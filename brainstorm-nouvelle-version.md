...
- **Suppression guidée** : une enveloppe avec un historique propose clôturer (recommandé), supprimer et libérer (l'argent redevient hors enveloppes), ou supprimer et réaffecter vers une autre enveloppe du compte. Interdite si elle alimente une ligne mensualisée (« démensualisez d'abord »).
