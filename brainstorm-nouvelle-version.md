...
- **Recalage** : dans « Nouveau mois » (montant réel de chaque enveloppe, « = compte » pour recopier le solde saisi) et bouton « Recaler sur le compte » dans Comptes. Import Mongo : script `align-envelopes.mjs` (initiale = solde du premier mois, ajustements mensuels).
